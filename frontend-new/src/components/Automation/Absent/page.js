    ...
    const fetchRecords = useCallback(async (page, perPage) => {
        ...
        try {
            const params = {
                ...
                types: ["absent"] // Only fetch absent type notifications for this page
            };
