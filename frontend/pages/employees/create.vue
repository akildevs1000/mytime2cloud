          ...
          <v-stepper-content step="1">
            <v-row dense>
              <v-col md="6" sm="12" cols="12" dense>
                ...
                <v-select v-model="payload.title" :items="titleItems" :hide-details="!errors.title" :error="errors.title"
              ...
              <v-col md="6" cols="12" sm="12" dense>
                ...
                <v-text-field dense outlined type="text" v-model="payload.employee_id" :hide-details="!errors.employee_id"
                  :error="errors.employee_id" :error-messages="errors && errors.employee_id ? errors.employee_id[0] : ''
                    "></v-text-field>
              </v-col>
              ...
              <v-col md="4" sm="12" cols="12" dense>
                ...
                <v-text-field dense outlined :hide-details="!errors.display_name" type="text"
                  v-model="payload.display_name" :error="errors.display_name" :error-messages="errors && errors.display_name ? errors.display_name[0] : ''
                    "></v-text-field>
              </v-col>
              <v-col md="4" sm="12" cols="12" dense>
            ...
            <v-row dense>
              ...
              <v-col md="6" cols="12" sm="12" dense>
                ...
                <v-text-field dense outlined type="number" v-model="contact.phone_number"
                  :hide-details="!errors.phone_number" :error="errors.phone_number" :error-messages="errors && errors.phone_number ? errors.phone_number[0] : ''
                    "></v-text-field>
              </v-col>

              <v-col md="6" cols="12" sm="12" dense>
                <label class="col-form-label">Whatsapp Number <span class="text-danger">*</span></label>
                <v-text-field dense outlined type="number" v-model="contact.whatsapp_number" class="input-group--focused"
              ...
              <v-col md="6" cols="12" sm="12" dense>
                ...
                <v-text-field dense outlined type="number" v-model="contact.phone_relative_number"
                  ...
                  :error="errors.phone_relative_number" :error-messages="errors && errors.phone_relative_number
              ...
              <v-col md="6" cols="12" sm="12" dense>
                ...
                <v-text-field dense outlined type="text" v-model="contact.country" :hide-details="!errors.country"
                  :error="errors.country" :error-messages="errors && errors.country ? errors.country[0] : ''
                    "></v-text-field>
              </v-col>
              <v-col md="12" cols="12" sm="12" dense>
                <label class="col-form-label">Address</label>
                <v-textarea dense outlined type="text" :hide-details="!errors.address" v-model="contact.address"
                  class="input-group--focused"></v-textarea>
              </v-col>
            </v-row>
            <v-row>
              <v-col cols="12">
            ...
            <v-row dense>
              ...
              <v-col md="6" cols="12" sm="12" dense>
                ...
                <v-select v-model="other.department_id" @change="getMultiple(other.department_id)" :items="departments"
                  ...
                  :error="errors.department_id" :error-messages="errors && errors.department_id
              ...
              <v-col md="6" cols="12" sm="12" dense>
                ...
                <v-select v-model="other.designation_id" :items="designations" dense item-text="name" item-value="id"
                  outlined :hide-details="!errors.designation_id" :error="errors.designation_id" :error-messages="errors && errors.designation_id
              ...
              <v-col md="6" cols="12" sm="12" dense>
                ...
                <v-select v-model="other.sub_department_id" :items="subDepartments" dense item-text="name" item-value="id"
                  outlined :hide-details="!errors.sub_department_id" :error="errors.sub_department_id" :error-messages="errors && errors.sub_department_id
              ...
              <v-col md="6" cols="12" sm="12" dense>
                ...
                <v-select v-model="other.grade" :items="['A', 'B', 'C']" dense outlined :hide-details="!errors.grade"
                  :error="errors.grade" :error-messages="errors && errors.grade ? errors.grade[0] : ''
                    "></v-select>
              </v-col>
              ...
              <v-col md="6" cols="12" sm="12" dense>
                ...
                <v-text-field dense outlined type="date" v-model="other.joining_date" :hide-details="!errors.joining_date"
                  :error="errors.joining_date" :error-messages="errors && errors.joining_date ? errors.joining_date[0] : ''
                    "></v-text-field>
              </v-col>
