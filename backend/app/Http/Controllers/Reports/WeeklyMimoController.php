...
class WeeklyMimoController extends Controller
{
    ...
    public function renderTable($data)
    {
        ...
        foreach ($data as $eid => $row) {
            ...
            $in1 = '<tr"><td><b>In</b></td>';
            $out1 = '<tr"><td><b>Out</b></td>';

            $in2 = '<tr"><td><b>In</b></td>';
            $out2 = '<tr"><td><b>Out</b></td>';

            $in3 = '<tr"><td><b>In</b></td>';
            $out3 = '<tr"><td><b>Out</b></td>';

            $in4 = '<tr"><td><b>In</b></td>';
            $out4 = '<tr"><td><b>Out</b></td>';

            $in5 = '<tr"><td><b>In</b></td>';
            $out5 = '<tr"><td><b>Out</b></td>';
            ...
            foreach ($row as $key => $record) {
                ...
                $in1 .= '<td style="text-align: center;"> ' . $record[0]['in'] . ' </td>';
                $out1 .= '<td style="text-align: center;"> ' . $record[0]['out'] . ' </td>';

                $in2 .= '<td style="text-align: center;"> ' . $record[0]['in'] . ' </td>';
                $out2 .= '<td style="text-align: center;"> ' . $record[0]['out'] . ' </td>';

                $in3 .= '<td style="text-align: center;"> ' . $record[0]['in'] . ' </td>';
                $out3 .= '<td style="text-align: center;"> ' . $record[0]['out'] . ' </td>';

                $in4 .= '<td style="text-align: center;"> ' . $record[0]['in'] . ' </td>';
                $out4 .= '<td style="text-align: center;"> ' . $record[0]['out'] . ' </td>';

                $in5 .= '<td style="text-align: center;"> ' . $record[0]['in'] . ' </td>';
                $out5 .= '<td style="text-align: center;"> ' . $record[0]['out'] . ' </td>';
            ...
            // $str = $str . $dates . $days . $in . $out . $work . $ot . $ot1 . $shift . $shift_type . $din . $dout . $status_tr;
            $str = $str . $dates . $days . $in1 . $out1 . $in2 . $out2 . $in3 .  $out3  . $in4 . $out4 . $in5  .  $out5 . $work . $ot .  $shift . $shift_type . $din . $dout . $status_tr;
