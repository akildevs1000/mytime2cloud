<template>
  <div v-if="can('employee_details_access')">
    ...
    <div v-if="!loading">
              ...
              <v-row>
                ...
                <v-col cols="6">
                  <div class="form-group">
                    ...
                    <input min="0" v-model="personalItem.no_of_spouse" class="form-control" type="text" />
        ...
        <v-row>
          ...
          <v-col cols="6 mt-4">
            <v-row>
              ...
              <v-col cols="6">
                {{ (payload && payload.phone_relative_number) || "----" }}
              </v-col>
              <v-col cols="6">
                <v-list-item-title class="text-bold mb-1">
                  Relation
      ...
      <v-card>
        <v-tabs md="12" class="mt-5 mb-5">
          ...
          <v-tab v-if="can(`employee_qualification_access`)">
            <v-icon left> mdi-file </v-icon>
            Qualification
          </v-tab>

          <v-tab v-if="can(`employee_setting_access`)">
          ...
          <!-- Personal info -->
          <v-tab-item v-if="can(`employee_personal_access`)">
            <v-row class="pl-1 mt-5 mb-5">
              ...
              <v-col cols="6">
                <v-row class="pa-4">
                  ...
                  <v-col cols="3" class="text-right" style="margin: -8px">
                    <v-icon v-if="can(`employee_personal_edit_access`)" @click="personal_info = true" small class="grey"
                      style="border-radius: 50%; padding: 5px" color="secondary">mdi-pencil</v-icon>
                  </v-col>
          ...
          <!-- Contact info -->
          <v-tab-item v-if="can(`employee_contact_access`)">
            <v-row class="pl-1 mt-5 mb-5">
              <v-col cols="12" class="text-right py-0">
                <v-col class="text-right" style="margin: -30px -30px -11px -5px">
                  <v-icon v-if="can(`employee_contact_edit_access`)" @click="contact_info = true" small class="grey"
                    style="border-radius: 50%; padding: 5px" color="secondary">mdi-pencil</v-icon>
                </v-col>
              </v-col>

              <v-col cols="6" style="border-right: 1px dashed #808080">
                <div class="theme--dark mt-0 px-2 py-2 primary text-white">
              ...
              <v-col cols="6">
                <div class="theme--dark mt-0 mr-1 px-2 py-2 primary text-white">
          ...
          <!-- Passport info -->
          <v-tab-item v-if="can(`employee_passport_access`)">
            <v-row class="pl-1 mt-5 mb-5">
              <v-col cols="6">
                <v-row class="pa-4">
                  <v-col cols="5">
              ...
              <v-col cols="6">
                <v-row class="pa-4">
                  ...
                  <v-col cols="3" class="text-right" style="margin: -8px">
                    <v-icon v-if="can(`employee_passport_edit_access`)" @click="passport_info = true" small class="grey"
                      style="border-radius: 50%; padding: 5px" color="secondary">mdi-pencil</v-icon>
                  </v-col>
          ...
          <!-- emirates info -->
          <v-tab-item v-if="can(`employee_emirate_access`)">
            <v-row class="pl-1 mt-5 mb-5">
              <v-col cols="6">
                <v-row class="pa-4">
                  <v-col cols="5">
              ...
              <v-col cols="6">
                <v-row class="pa-4">
                  ...
                  <v-col cols="3" class="text-right" style="margin: -8px">
                    <v-icon v-if="can(`employee_emirate_edit_access`)" @click="emirate_info = true" small class="grey"
                      style="border-radius: 50%; padding: 5px" color="secondary">mdi-pencil</v-icon>
                  </v-col>
          ...
          <!-- visa info -->
          <v-tab-item v-if="can(`employee_visa_access`)">
            <v-row class="pl-1 mt-5 mb-5">
              <v-col cols="6">
                <v-row class="pa-4">
                  <v-col cols="5">
              ...
              <v-col cols="6">
                <v-row class="pa-4">
                  ...
                  <v-col cols="3" class="text-right" style="margin: -8px">
                    <v-icon v-if="can(`employee_visa_edit_access`)" @click="visa_info = true" small class="grey"
                      style="border-radius: 50%; padding: 5px" color="secondary">mdi-pencil</v-icon>
                  </v-col>
          ...
          <!-- Bank info -->
          <v-tab-item v-if="can(`employee_bank_access`)">
            <v-row class="pl-1 mt-5 mb-5">
              <v-col cols="6">
                <v-row class="pa-4">
                  <v-col cols="5">
                  ...
                  <v-col cols="3" class="text-right" style="margin: -8px">
                    <v-icon v-if="can(`employee_bank_edit_access`)" @click="bank_info = true" small class="grey"
                      style="border-radius: 50%; padding: 5px" color="secondary">mdi-pencil</v-icon>
                  </v-col>
                  <v-col cols="5">
                    <v-list-item-title class="text-bold mb-1">
          ...
          <!-- Documents -->
          <v-tab-item v-if="can(`employee_document_access`)">
            <v-row class="pl-1 mt-5 mb-5">
              <v-col cols="6">
                <v-row v-for="(d, index) in document_list" :key="index" class="pa-2">
                  ...
                  <v-col cols="3" class="text-right" style="margin: -8px">
                    <v-icon v-if="can(`employee_document_edit_access`) && !index" @click="documents = true" small
          ...
          <!-- Qualification -->
          <v-tab-item v-if="can(`employee_qualification_access`)">
            <v-row class="pl-1 mt-5 mb-5">
              <v-col cols="6">
                <v-row class="pa-4">
                  <v-col cols="5">
                  ...
                  <v-col cols="3" class="text-right" style="margin: -8px">
                    <v-icon v-if="can(`employee_qualification_edit_access`)" @click="qualification_info = true" small
                      class="grey" style="border-radius: 50%; padding: 5px" color="secondary">mdi-pencil</v-icon>
                  </v-col>
                  <v-col cols="5">
                    <v-list-item-title class="text-bold mb-1">
          ...
          <!-- Other Info -->
          <v-tab-item v-if="can(`employee_setting_access`)">
            <v-row class="pl-1 mt-5 mb-5">
              <v-col cols="6">
          ...
          <v-tab-item v-if="can(`employee_setting_access`)">
            <v-row class="pl-1 mt-5 mb-5">
              <v-col cols="12">
                <v-row class="pa-4 ml-2 no-gutters">
                  <EMPLOYEETOREPORT :currentUser="getEmployeeId" />
                </v-row>
              </v-col>
            </v-row>
          </v-tab-item>
