      ...
      <v-col md="12">
        ...
        <v-card class="mb-5 rounded-md" elevation="0">
          <v-toolbar class="rounded-md" color="background" dense flat dark>
            <v-toolbar-title><span> Dashboard / {{ Model }} </span></v-toolbar-title>
            ...
            <!-- <v-toolbar-items>
              <v-col class="toolbaritems-button-design1">
                <v-btn v-if="can(`leaves_create`)" small color="primary" @click="dialog = true" class="mb-2">{{
                  Model }}
                  +</v-btn>
              </v-col>
            </v-toolbar-items> -->
          ...
          <v-data-table v-if="can(`leave_view`)" v-model="ids" item-key="id" :headers="headers" :items="data"
                ...
                <v-list width="120" dense>
                  ...
                  <v-list-item @click="editItem(item)">
                    <v-list-item-title style="cursor: pointer">
                      <v-icon v-if="can(`holidays_edit`)" color="secondary" small @click="editItem(item)">
                        mdi-pencil
                      </v-icon> Edit
                    </v-list-item-title>
                  </v-list-item>
                  <v-list-item @click="deleteItem(item)">
                    <v-list-item-title style="cursor: pointer">
                      <v-icon v-if="can(`holidays_delete`)" color="error" small @click="deleteItem(item)">
...
export default {
  ...
  data: () => ({
    ...
    headers: [
      { text: "Employee Name", align: "left", sortable: true, key: "name", value: "name" },
      {
        text: "Leave Type",
        align: "left",
        sortable: true,
