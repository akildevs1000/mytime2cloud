...
class GenerateAttendanceReportPDF implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $filePath = $reportsDirectory . DIRECTORY_SEPARATOR . "Attendance_Report_{$template}_{$this->requestPayload["from_date"]}_{$this->requestPayload["to_date"]}_{$this->employeeId}.pdf";
