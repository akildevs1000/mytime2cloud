...
class SyncMultiShiftNight extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'task:sync_multi_shift_night {company_id} {date}';
    ...
    public function handle()
    {
        ...
        try {
            echo (new MultiShiftController)->render($id, $date, $shift_type_id, [], true) . "\n";
        } catch (\Throwable $th) {
            //throw $th;
