...
class SyncDoubleShift extends Command
{
    ...
    public function handle()
    {
        ...
        $responseMessage = "*****Cron started at $formattedDate for task:sync_double_shift*****\n";
        ...
        $responseMessage .= "*****task:sync_double_shift payload start*****\n";
        $responseMessage .= "$message\n";
        $responseMessage .= "*****task:sync_double_shift payload end*****\n";
        $responseMessage .= "*****Cron ended for task:sync_double_shift*****\n";
