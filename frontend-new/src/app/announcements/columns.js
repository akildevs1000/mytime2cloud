    ...
    return [
        {
            ...
            render: (e) => (
                <p
                    ...
                    className="text-sm text-slate-500 dark:text-slate-400 font-mono cursor-pointer hover:text-primary transition-colors font-medium"
                >
                    {e.title || "N/A"}
                </p>
            ),
        },
        {
            ...
            render: (e) => (
                <p
                    onClick={() => handleRowClick(e)}
                    className="text-sm text-slate-500 dark:text-slate-400 hidden xl:table-cell font-mono cursor-pointer max-w-[300px] truncate"
