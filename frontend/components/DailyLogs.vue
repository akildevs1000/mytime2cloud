                ...
                <div class="card mx-2 my-2 w-25">
                  ...
                  <div class="actions">
                    <div class="follow-info">
                      ...
                      <h2>
                        <a href="#"
                          ><span>{{ item.device_in.short_name }}</span
                          ><small>Device Name</small></a
                        >
                      </h2>
                    </div>
                    <div class="follow-btn">
                      <button>IT Dep</button>
                    </div>
                  </div>
                  <div class="desc">
                    Morgan has collected ants since they were six years old and
                    now has many dozen ants but none in their pants.
                  </div>
                </div>
              </v-slide-item>
            </v-slide-group>
