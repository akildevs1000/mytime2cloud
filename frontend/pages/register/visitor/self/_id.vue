    ...
    <v-stepper v-model="step">
      <v-stepper-content step="1">
        <v-row>
          ...
          <v-col cols="12">
            <v-btn block :loading="loading" color="primary" @click="nextStep">
              Next
            </v-btn>
          </v-col>
        </v-row>
      ...
      <v-stepper-content step="2" style="min-height: 650px">
        <v-row class="pt-5">
          <v-col cols="12">
            <v-text-field
            ...
            <v-text-field
              ...
              :error-messages="
                errors && errors.host_company_name
                  ...
                  : ''
              "
              label="Host Company Name (optional)"
            ></v-text-field>
          </v-col>
          ...
          <v-col cols="12">
            <v-text-field
              ...
              "
              label="Host Email Address (optional)"
            ></v-text-field>
          </v-col>
        </v-row>
        ...
        <v-row>
          ...
          <v-col cols="12">
            <v-btn block color="primary" @click="prevStep">Previous</v-btn>
          </v-col>
        </v-row>
      </v-stepper-content>
    </v-stepper>
