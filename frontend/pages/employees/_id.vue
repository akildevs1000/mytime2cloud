                  ...
                  <v-card-text>
                    <v-row dense>
                      ...
                      <v-col md="6" cols="12" sm="12" dense>
                        ...
                        <v-text-field dense outlined type="text" :hide-details="!errors.file_no"
                          v-model="payload.file_no" :error="errors.file_no" :error-messages="
                      ...
                      <v-col md="6" cols="12" sm="12" dense>
                        ...
                        <v-text-field dense outlined type="text" v-model="payload.first_name"
                          :hide-details="!errors.first_name" :error="errors.first_name" :error-messages="
                      ...
                      <v-col md="6" cols="12" sm="12" dense>
                        ...
                        <v-text-field dense outlined type="text" v-model="payload.email" :hide-details="!errors.email"
                  ...
                  <v-card-text>
                    <v-row dense>
                      <v-col md="6" cols="12" sm="12" dense>
                        ...
                        <v-text-field dense outlined type="text" :hide-details="!errors.local_address"
                          v-model="contact.local_address" class="input-group--focused"></v-text-field>
                      </v-col>

                      <v-col md="6" cols="12" sm="12" dense>
                        <label class="col-form-label">Email </label>
                        <v-text-field dense outlined type="email" v-model="contact.local_email"
                          :hide-details="!errors.local_email"></v-text-field>
                      </v-col>
                      <v-col md="6" cols="12" sm="12" dense>
                        <label class="col-form-label">Phone Number
                          <span class="text-danger">*</span></label>
                        <v-text-field dense outlined type="text" v-model="contact.phone_number"
                      ...
                      <v-col md="6" cols="12" sm="12" dense>
                        <label class="col-form-label">Whatsapp Number
                          <span class="text-danger">*</span></label>
                        <v-text-field dense outlined type="text" v-model="contact.whatsapp_number"
                      ...
                      <v-col md="6" cols="12" sm="12" dense>
                        <label class="col-form-label">Relative Number
                          <span class="text-danger">*</span></label>
                        <v-text-field dense outlined type="text" v-model="contact.phone_relative_number"
                      ...
                      <v-col md="6" cols="12" sm="12" dense>
                        ...
                        <v-text-field dense outlined type="text" v-model="contact.local_city"
                          :hide-details="!errors.local_city" :error="errors.city" :error-messages="
                      ...
                      <v-col md="6" cols="12" sm="12" dense>
                        ...
                        <v-text-field dense outlined type="text" v-model="contact.local_country"
                          :hide-details="!errors.local_country" :error="errors.local_country" :error-messages="
                    ...
                    <v-row dense>
                      ...
                      <v-col md="6" cols="12" sm="12" dense>
                        ...
                        <v-select v-model="other.department_id" @change="getMultiple(other.department_id)"
                          ...
                          :hide-details="!errors.department_id" :error="errors.department_id" :error-messages="
                      ...
                      <v-col md="6" cols="12" sm="12" dense>
                        ...
                        <v-select v-model="other.sub_department_id" :items="subDepartments" dense item-text="name"
                          ...
                          :error="errors.sub_department_id" :error-messages="
                      ...
                      <v-col md="6" cols="12" sm="12" dense>
                        ...
                        <v-select v-model="other.type" :items="['limit', 'test']" dense outlined
                          :hide-details="!errors.type" :error="errors.type" :error-messages="
                      ...
                      <v-col md="6" cols="12" sm="12" dense>
                        ...
                        <v-select v-model="other.grade" :items="['A', 'B', 'C']" dense outlined
                          :hide-details="!errors.grade" :error="errors.grade" :error-messages="
