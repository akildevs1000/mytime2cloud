      ...
      <v-col cols="6" xs="6" sm="12" md="6" lg="6" xl="6">
        <v-col md="12" sm="12" cols="12">
          ...
          <v-autocomplete :items="leave_groups" item-text="group_name" item-value="id" placeholder="Select"
            ...
            :error-messages="errors && errors.leave_group_id ? errors.leave_group_id[0] : ''
              " dense outlined></v-autocomplete>
        </v-col>
        <v-col md="12" sm="12" sx="12" xl="12" cols="12" outlined>
          <label class="col-form-label"><strong>Leave Manager/Reporting Manger</strong>
          </label>
        ...
        <table style="width: 70%">
          ...
          <tr>
            ...
            <td>
              ...
              <div class="text-overline mb-1">
                <v-switch color="success" class="mt-0 ml-2" v-model="setting.user.enable_whatsapp_otp"></v-switch>
              </div>
            </td>
          </tr>
        </table>
