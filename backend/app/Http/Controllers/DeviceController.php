    ...
    public function getLastRecordsHistory($id = 0, $count = 0, Request $request)
    {
        ...
        $model->join('employees', 'attendance_logs.UserID', '=', 'employees.system_user_id')
            ...
            ->select([
                ...
                'employees.last_name',
                DB::raw("CONCAT('https://backend.mytime2cloud.com/media/employee/profile_picture/', employees.profile_picture) as profile_picture"), // Prepend the URL to profile_picture
