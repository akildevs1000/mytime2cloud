...
.ngx-datatable.scroll-vertical.virtualized
  .datatable-body
...
.rtl section.content {
  margin: 35px 260px 0px 15px;
  min-height: calc(100vh - 76px);
  transition: 0.5s;
}

.rtl section.content .content-block {
  padding: 25px 25px 0px 0px;
}

.rtl .breadcrumb-main .page-title {
  border-right: none;
  padding-right: 0px;
}

.rtl .breadcrumb-main .page-title:after {
  display: none;
}

.rtl .breadcrumb-main .breadcrumb-list {
  float: left;
}

.rtl .breadcrumb-main li a .fa-home {
  float: right;
  padding-right: 10px;
  padding-left: unset;
}

.rtl .breadcrumb-main .breadcrumb-item + .breadcrumb-item {
  padding-right: 5px;
  padding-left: unset;
}

.rtl .breadcrumb-main .breadcrumb-item + .breadcrumb-item:after {
  content: "\f104";
...
.rtl .breadcrumb-main .breadcrumb-item + .breadcrumb-item:before {
  display: none;
}
...
.rtl .mat-radio-button ~ .mat-radio-button {
  margin-right: 16px;
}
...
.rtl.side-closed.side-closed-hover .sidebar .menu .list li .sidebarIcon {
  float: right;
  line-height: 2rem;
}
...
.rtl .sidebar .menu .list .active .ml-menu li a {
  padding-right: 46px;
  padding-left: unset;
  padding-top: 4px;
  padding-bottom: 4px;
...
.rtl .sidebar .menu .list .ml-menu li a:hover:before {
  font-weight: 600;
  right: 30px;
}

.rtl .sidebar .menu .list .ml-menu li.active a:hover:before {
  font-weight: 600;
  right: 30px;
}
...
.rtl .card-statistic-3 .card-icon {
  left: -5px;
  right: unset;
  margin-left: 0px;
}

.rtl .card-statistic-2 .card-right {
  float: left;
...
.rtl .lang-dropdown .country-name {
  margin-right: 5px;
}

.rtl .lang-item .lang-item-list {
  text-align: right;
}
...
.rtl.overlay-open.ls-closed .sidebar {
  margin-right: 0;
  margin-left: unset;
}
...
.rtl .settingSidebar.showSettingPanel {
  left: 0;
  right: unset;
}

.rtl .settingSidebar .settingPanelToggle {
  background: #6777ef;
  padding: 10px 15px;
  color: #fff;
  position: absolute;
...
.breadcrumb-main li .material-icons {
  font-size: 18px;
  position: relative;
  top: 4px;
  float: none;
...
.breadcrumb-main .page-title i {
  padding: 0px 5px;
}

.breadcrumb-main .page-title i:before {
  color: #717883;
  font-size: 20px;
}
...
.breadcrumb-bg-gray li {
  color: #fff !important;
}

.breadcrumb-bg-gray li a {
  color: #fff;
  font-weight: bold;
}

.breadcrumb-bg-gray li a .material-icons {
  padding-bottom: 8px;
}

.breadcrumb-bg-gray li + li:before {
  color: #fff;
}

.breadcrumb-col-gray-dark li a {
...
.breadcrumb-bg-gray-dark li {
  color: #fff !important;
}

.breadcrumb-bg-gray-dark li a {
  color: #fff;
  font-weight: bold;
}

.breadcrumb-bg-gray-dark li a .material-icons {
  padding-bottom: 8px;
}

.breadcrumb-bg-gray-dark li + li:before {
  color: #fff;
}
...
:checked.chk-col-gray + span:after {
  color: #6c757d;
}

:checked.chk-col-gray-dark + span:after {
  color: #343a40;
}
...
[type="radio"].with-gap.radio-col-gray:checked + label:before {
  border: 2px solid #6c757d;
}
...
[type="radio"].with-gap.radio-col-gray-dark:checked + label:before {
  border: 2px solid #343a40;
}
...
.dropdown-menu ul.menu .nfc-close {
  display: flex;
  height: 40px;
  line-height: 40px;
}

.dropdown-menu ul.menu .nfc-close .feather {
  color: #747474;
  height: 12px !important;
  width: 12px !important;
}

.dropdown-menu ul.menu .nfc-type-icon {
  height: 40px;
  width: 40px;
  display: flex;
  align-items: center;
...
.dropdown-menu ul.menu .nfc-type-icon.nfc-green {
  filter: invert(77%) sepia(4%) saturate(5247%) hue-rotate(85deg)
    brightness(88%) contrast(95%);
}

.dropdown-menu ul.menu .nfc-type-icon.nfc-blue {
  filter: invert(67%) sepia(95%) saturate(5173%) hue-rotate(214deg)
    brightness(101%) contrast(101%);
}

.dropdown-menu ul.menu .nfc-type-icon.nfc-orange {
  filter: invert(69%) sepia(81%) saturate(523%) hue-rotate(353deg)
    brightness(101%) contrast(102%);
}

.dropdown-menu ul.menu .nfc-type-icon.nfc-purple {
  filter: invert(19%) sepia(98%) saturate(7474%) hue-rotate(284deg)
    brightness(105%) contrast(117%);
}

.dropdown-menu ul.menu .nfc-type-icon.nfc-red {
  filter: invert(24%) sepia(94%) saturate(7102%) hue-rotate(356deg)
    brightness(103%) contrast(100%);
}

.dropdown-menu ul.menu .msg-unread {
  background-color: #f5f9ff;
  border-bottom: 1px solid #eee;
}

.dropdown-menu ul.menu .msg-read {
  border-bottom: 1px solid #eee;
}

.dropdown-menu .nfc-read-more {
  display: block;
  text-align: center;
  color: #000000;
}
...
.sidebar .menu .list li.active .menu-top {
...
.sidebar .menu .list .material-icons-two-tone {
  vertical-align: middle;
  filter: invert(43%) sepia(4%) saturate(19%) hue-rotate(342deg) brightness(94%)
    contrast(88%);
}
...
.sidebar .menu .list .ml-menu li.active a:hover:before {
  font-weight: 600;
  left: 30px;
}
...
.sidebar .menu .list .ml-menu li.active .ml-menu {
  color: #5668f3;
  font-weight: 500;
}

.sidebar .menu .list .ml-menu li.active .ml-sub-sub-menu {
  color: #5668f3;
  font-weight: 500;
}

.sidebar .menu .list .ml-menu li a.ml-sub-sub-menu:before {
  content: "\f105";
  font-family: "Font Awesome 5 Free";
  font-size: 13px;
  display: block;
...
.sidebar .menu .list .ml-menu li a.ml-sub-sub-menu:hover:before {
  font-weight: 600;
  left: 50px;
}
...
.menu_dark .sidebar .menu .list .menu-toggle::after {
  color: #b8babb;
}

.menu_dark .sidebar .menu .list .menu-toggle::before {
  color: #b8babb;
}

.menu_dark .sidebar .menu .list .material-icons-two-tone {
  filter: invert(86%) sepia(3%) saturate(2995%) hue-rotate(185deg)
    brightness(79%) contrast(78%);
}

.menu_dark .sidebar .menu .list .ml-menu li a {
  color: #dadada;
}

.menu_dark .sidebar .menu .list li.active .menu-top {
  background-color: rgba(0, 0, 0, 0.4);
}

.menu_dark .sidebar .menu .list .ml-menu .active a::before {
  content: "\f105";
  font-family: "Font Awesome 5 Free";
  font-size: 13px;
  display: block;
...
.menu_dark .profile-usertitle-job {
  color: #e6e6e6;
}
...
.sidebar-userpic-btn a .mat-button-wrapper {
...
.navbar-nav.navbar-right .user_profile .dropdown-toggle {
  cursor: pointer;
}
...
.lang-item .lang-item-list.active {
...
.lang-item .lang-item-list .flag-img {
  margin: 0px 5px;
  height: 15px;
  border-radius: 3px;
}
...
.notification-dropdown .nfc-header h5,
.notification-dropdown .nfc-header .h5 {
  color: #fff;
}
...
.nav .btnHeaderSetting {
  margin: 0px 8px;
}

.nav .btnHeaderSetting .settingBtn {
  vertical-align: top;
}
...
.side-closed.side-closed-hover .sidebar .menu .list li .sidebarIcon {
  float: left;
  line-height: 2rem;
}
...
.rightSetting .mat-button-toggle-checked {
  background-color: #6e68c1;
  color: #ffffff !important;
}

.rightSetting .mat-button-toggle {
  width: 60px;
  height: 30px;
  font-size: 14px;
}
...
.switch
  ...
  box-shadow: 0 1px 3px 1px rgba(0, 0, 0, 0.4),
    0 0 0 15px rgba(102, 16, 242, 0.1);
}
...
.switch
  ...
  box-shadow: 0 1px 3px 1px rgba(0, 0, 0, 0.4),
    0 0 0 15px rgba(111, 66, 193, 0.1);
}
...
.switch
  ...
  box-shadow: 0 1px 3px 1px rgba(0, 0, 0, 0.4),
    0 0 0 15px rgba(214, 51, 132, 0.1);
}
...
.switch
  ...
  box-shadow: 0 1px 3px 1px rgba(0, 0, 0, 0.4),
    0 0 0 15px rgba(253, 126, 20, 0.1);
}
...
.switch
  ...
  box-shadow: 0 1px 3px 1px rgba(0, 0, 0, 0.4),
    0 0 0 15px rgba(32, 201, 151, 0.1);
}
...
.switch
  ...
  box-shadow: 0 1px 3px 1px rgba(0, 0, 0, 0.4),
    0 0 0 15px rgba(13, 202, 240, 0.1);
}
...
.switch
  label
  input[type="checkbox"]:checked:not(:disabled)
  ~ .lever.switch-col-gray:active:after {
  box-shadow: 0 1px 3px 1px rgba(0, 0, 0, 0.4),
    0 0 0 15px rgba(108, 117, 125, 0.1);
}
...
.switch
  label
  input[type="checkbox"]:checked:not(:disabled)
  ~ .lever.switch-col-gray-dark:active:after {
  box-shadow: 0 1px 3px 1px rgba(0, 0, 0, 0.4), 0 0 0 15px rgba(52, 58, 64, 0.1);
}
...
.switch
  ...
  + .lever.switch-col-gray-dark:after {
  background-color: #343a40;
}
/*
...
.settingSidebar .settingPanelToggle .setting-sidebar-icon .feather {
  height: 17px;
  width: 17px;
}
...
.contact-details-field .color-icon {
  filter: invert(14%) sepia(0%) saturate(5141%) hue-rotate(101deg)
...
.cd-timeline-img {
  ...
  height: 40px;
  border-radius: 50%;
  box-shadow: 0 0 0 4px #e6dfdf, inset 0 2px 0 rgba(0, 0, 0, 0.08),
...
.board .list {
  ...
  box-shadow: 0 0.125rem 0.125rem rgba(0, 0, 0, 0.03),
    0 0.0625rem 0.3125rem rgba(0, 0, 0, 0.02);
  overflow: hidden;
}
...
.board .list .projects.cdk-drop-list-dragging {
  opacity: 0.65;
}

.board .list .projects .cdk-drag-placeholder {
  display: none;
}
...
.project:hover {
  box-shadow: 0 0.125rem 0.125rem rgba(0, 0, 0, 0.1),
    0 0.0625rem 0.3125rem rgba(0, 0, 0, 0.09);
}
...
.project .gravity .priority {
  flex: 1;
}

.project .gravity .deadline {
  margin-right: -1rem;
  text-align: right;
}

.project .gravity .deadline .icon {
...
.project .project-actions[aria-expanded="true"],
...
.patient-group-list .lbl-bedge .lbl-bedge-title {
  color: #ffffff;
  display: flex;
  align-items: center;
  justify-content: center;
...
.patient-group-list .group-details {
  line-height: 38px;
  padding-left: 10px;
  font-weight: 500;
}
...
.card.card-statistic-2 .card-right {
  float: right;
...
.card .card-statistic-3 .card-content .data-1 {
  font-size: 25px;
  font-weight: 600;
}
...
.mat-progress-bar.progress-xs {
  height: 4px;
}

.mat-progress-bar.progress-s {
  height: 5px;
}

.mat-progress-bar.progress-m {
  height: 10px;
}

.mat-progress-bar.progress-round {
  border-radius: 7px;
}

.mat-progress-bar.green-progress .mat-progress-bar-fill::after {
  background-color: #0af30a !important;
}

.mat-progress-bar.sky-progress .mat-progress-bar-fill::after {
  background-color: #248afd !important;
}

.mat-progress-bar.orange-progress .mat-progress-bar-fill::after {
  background-color: #ffc100 !important;
}

.mat-progress-bar.red-progress .mat-progress-bar-fill::after {
  background-color: #ff4747 !important;
}

.mat-progress-bar.l-green-progress .mat-progress-bar-fill::after {
  background: #11998e;
...
.mat-progress-bar.l-sky-progress .mat-progress-bar-fill::after {
  background: #36d1dc;
  /* fallback for old browsers */
  /* Chrome 10-25, Safari 5.1-6 */
...
.mat-progress-bar.l-orange-progress .mat-progress-bar-fill::after {
  background: #f12711;
  /* fallback for old browsers */
  /* Chrome 10-25, Safari 5.1-6 */
...
.mat-progress-bar.l-red-progress .mat-progress-bar-fill::after {
  background: #ff416c;
  /* fallback for old browsers */
  /* Chrome 10-25, Safari 5.1-6 */
...
.mat-progress-bar.l-purple-progress .mat-progress-bar-fill::after {
  background: #7f00ff;
  /* fallback for old browsers */
  /* Chrome 10-25, Safari 5.1-6 */
...
.mat-progress-bar.progress-shadow {
...
.dark .contact-details-field .color-icon {
  filter: invert(68%) sepia(6%) saturate(787%) hue-rotate(177deg)
